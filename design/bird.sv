...
// ============================================================
//
// NOTE: This file is the instructor-provided DUT, copied verbatim from
// https://github.com/elias-bzu/bird (design/bird.sv). DO NOT MODIFY IT.
// It is the design we verify; any change here invalidates the verification.
// ============================================================
